...
var2=outer()  # 새로운 객체(inner) 생성/ var2 = inner
print(var2()) # 1
print(var2()) # 2
...
@make2 
@make1
def hello2(): #hello2 = make2(make1(hello2))
    return "신기해"
print(hello2())
...
#같은 패키지내 from pack1.mymod1 import mbc, tot
#다른 패키지 from pack1_other import mymod2
...
# 지역변수 > 모듈 전역 변수 > class 멤버 변수 (찾기 우선순위)
